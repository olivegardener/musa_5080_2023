...
weather.Panel <- 
  riem_measures(station = "PHL", date_start = "2018-05-01", date_end = "2018-05-31") %>%
...
study.panel <- 
  ...
  left_join(., dat_census %>%
              dplyr::select(from_station_id, from_station_name, Origin.Tract, from_longitude, from_latitude )%>%
              distinct() %>%
