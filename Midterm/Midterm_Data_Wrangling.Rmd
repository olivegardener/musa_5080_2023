...
tracts2020 <- 
  ...
  mutate(year = "2020", 
         ...
         Car2WorkPct = (Car2Work/TotalPop)) %>%
  dplyr::select(-NAME, -White, -NumBach, -YrBuilt, -Car2Work, -starts_with("B"))
```
...
st_write(TotalPop, "data/TotalPop.geojson", delete_dsn = TRUE)
st_write(MedHHInc, "data/MedHHInc.geojson", delete_dsn = TRUE)
st_write(MedRent, "data/MedRent.geojson", delete_dsn = TRUE)
st_write(HomeOwnRate, "data/HomeOwnRate.geojson", delete_dsn = TRUE)
st_write(PctWhite, "data/PctWhite.geojson", delete_dsn = TRUE)
st_write(PopDensity, "data/PopDensity.geojson", delete_dsn = TRUE)
st_write(PctBach, "data/PctBach.geojson", delete_dsn = TRUE)
st_write(Car2WorkPct, "data/Car2WorkPct.geojson", delete_dsn = TRUE)
st_write(HouseAge, "data/HouseAge.geojson", delete_dsn = TRUE)
