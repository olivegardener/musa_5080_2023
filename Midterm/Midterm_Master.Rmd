...
print("Correlation of total_area and total_livable_area:")
cor(Houses$total_area, Houses$total_livable_area, use="complete.obs", method="pearson")
print("Correlation of interior_condition and exterior_condition:")
cor(Houses$interior_condition, Houses$exterior_condition, use="complete.obs", method="pearson")
print("Correlation of number_of_bedrooms and number_of_rooms:")
cor(Houses$number_of_bedrooms, Houses$number_of_rooms, use="complete.obs", method="pearson")
print("Correlation of number_of_bedrooms and total_livable_area:")
cor(Houses$number_of_bedrooms, Houses$total_livable_area, use="complete.obs", method="pearson")
print("Correlation of number_of_rooms and total_livable_area:")
cor(Houses$number_of_rooms, Houses$total_livable_area, use="complete.obs", method="pearson")
print("Correlation of RecyclingRate and MedHHInc_ACS:")
cor(Houses$RecyclingRate, Houses$MedHHInc_ACS, use="complete.obs", method="pearson")
print("Correlation of RecyclingRate and MedRent_ACS:")
cor(Houses$RecyclingRate, Houses$MedHHInc_ACS, use="complete.obs", method="pearson")
...
reg1 <- lm(sale_price ~ ., data = select_if(st_drop_geometry(Houses), is.numeric))
summary(reg1)
