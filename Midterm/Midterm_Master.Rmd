...
st_drop_geometry(model_data) %>% 
  select(sale_price, vacant_lots_nn3, playgrounds_nn2, quality_produce_access, tree.count.buffer) %>%
...
```
This shows that the model is good at predicting across much of the city, with errors clustered in a small handful of neighborhoods. Why is the absolute percent error so high in these neighborhoods?
