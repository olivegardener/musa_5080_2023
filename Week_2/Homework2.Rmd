...
# stops_rent_sf <- stops_rent_sf +
#   labs(fill = "Distance to Bart (mi)") +  # Update legend title for fill
#   guides(size = guide_legend(order = 1),  # Order for size legend
#          fill = guide_legend(order = 2)) +  # Order for fill legend
#   theme(legend.position = "bottom",       # Override common_theme for this plot
#         legend.box = "vertical")
