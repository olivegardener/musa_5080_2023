...
# Create a logical vector where TRUE means the tract intersects with sf_county_sf
intersects_with <- st_intersects(tracts09, sf_county_sf, sparse = FALSE) %>% apply(1, any)

# Subset tracts_sf with the logical vector
tracts09 <- tracts09[intersects_with, ]
