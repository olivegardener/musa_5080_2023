...
enter1 <- sum(sampled_data1$EnterProgram == 1)/count(sampled_data1)
enter2 <- sum(sampled_data2$EnterProgram == 1)/count(sampled_data2)
enter3 <- sum(sampled_data3$EnterProgram == 1)/count(sampled_data3)
...
predict_success_ratio <- sum(testProbs$predOutcome == 1) / count(testProbs)
